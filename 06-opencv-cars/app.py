...
blurring_gaussian_kernel_size = (21, 21)
# Minimum object dimensions (height, width)
min_object_shape = (20, 20)
...
video_stream = cv2.VideoCapture("videos/CarsDrivingUnderBridge.mp4")
...
while ret and frame.shape[0] > 0 and frame.shape[1] > 0:
    ...
    for cnt in cnts:
        ...
        if y > n_pixels_exclude_top:  # Disregard item that are the top of the picture
